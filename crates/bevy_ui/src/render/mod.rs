...
use crate::{
    BackgroundColor, BorderColor, CalculatedClip, ComputedBorderThickness, ContentSize,
    DefaultUiCamera, Node, Outline, TargetCamera, UiImage, UiScale, UiStack,
};
...
pub fn extract_uinode_borders(
    ...
    for (node, global_transform, border_color, border_thickness, view_visibility, clip, camera) in
        &uinode_query
    {
